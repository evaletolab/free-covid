...
C'est la panique, on ne controle pas le taux de reproduction et  à plusieurs reprises, le gouvernement a usé  du Lockdown brutal et discriminatoire. On ne peut pas mettre en concurrence la mort des PME, avec la mort des personnes à risques. Ces deux groupes doivent être protégés. 
