...
Et si la stratégie de depistage Suisse était multiple ? Actuellement elle part du principe que dès les premiers symptomes,il faut contacter son médecin ou utilisez une des offres de dépsitage du canton. A genève il existe une solution de test rapide (m3-test.ch), mais il faut quand même prendre rendez-vous, faire la queue, et sans symptome il faut payer une facture de XXX chf ([source](https://www.bag.admin.ch/bag/fr/home/krankheiten/ausbrueche-epidemien-pandemien/aktuelle-ausbrueche-epidemien/novel-cov/testen.html#2051828467))
