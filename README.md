...
Et si il y avait plusieurs stratégies de depistage ? Actuellement, il y en a une, elle stipule que dès les premiers symptomes, il faut contacter son médecin ou utilisez une les offres de dépsitage du canton. A genève il existe plusieurs solutions de test rapide comme m3-test.ch, mais il faut quand même prendre rendez-vous, faire la queue, et sans symptome il faut payer une facture de XXX chf ([source](https://www.bag.admin.ch/bag/fr/home/krankheiten/ausbrueche-epidemien-pandemien/aktuelle-ausbrueche-epidemien/novel-cov/testen.html#2051828467)) L'indicateur principal  permet d'agir sur la valeur du nombre de reproduction Re ([Ro](https://www.covid19.admin.ch/fr/repro/val) ) qui pour simplifier, si sa valeur `Re > 1.0` alors la politique de lockdown se durci et le fédéralisme est mis sur pause.

La prosition du Professeur Michael Mina (Epidemiology, Harvard T.H) souligne que le protocole actuel est trop lent et que le problème de vitesse est un problème d'ingénieur. Il part du principe que le control de `Re` par le lockdown ne peut être qu'une solution d'urgence, efficace pour gagner un peu de temps, mais en dehors de l'urgence, c'est un problème. L'hypothèse de M. Mina est simple à mettre en oeuvre. A la place de tout fermer, il faut permettre les tests rapides, bon marchés (5 fr), efficaces, et utilisables anonymement depuis la maison. Conjointement, il faut une solution technique, neutre et anonyme, qui permette de produire une carte "météo" du virus et d'avertir les personnes qui ont traversés un lieu a moment donné qui est considéré comme risqué. Lorsqu'un risque de contamination existe, on informe, et on tests rapidement, sans cout et anonymement.
