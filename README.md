...
Comme indiqué plus haut, la solution de l'équipe du Pr Michael Mina, consiste à renforcer les mesures de dépistage.  **Le dépistage est un problème technique qui peut être amélioré avec des ordres de grandeurs d'un facteur 100**
...
Tous les lieux considérés comme clusters potentiels; spectacles, restaurants, bistrots, commerces, clubs, etc., pourraient être ouverts si et seulement si, on est certains que les personnes contagieuses n'y entrent pas. Avec des tests rapides, et en option une application mobile on peut approcher une certitude à presque 100%.
